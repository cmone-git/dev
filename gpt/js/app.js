  ...
  <div class="cm-header-inner">
    ...
    <div class="cm-header-left">
      ...
      <div class="cm-brand">
        ...
        <div>
          <div class="cm-brand-title">BIZODIT</div>
...
<main class="main">
  ...
  <div class="page">
    ...
    <section class="dashboard-panel dashboard-quick-panel">
      <div class="dashboard-panel-head">
        <div>
          <h2 class="dashboard-panel-title">Accounts & CRM Quick Access</h2>
          <p class="dashboard-panel-sub">Open commonly used business records</p>
        </div>
      </div>
      <div class="dashboard-quick-links">
        <a class="dashboard-quick-link" href="modules/crm/compliance/forms/compliance.html">
          <i data-lucide="file-check-2"></i><span>Compliance</span><small>CRM</small>
        </a>
        <a class="dashboard-quick-link" href="modules/accounts/ledgers/forms/ledger.html">
          <i data-lucide="book-open"></i><span>Ledgers</span><small>Accounts</small>
        </a>
        <a class="dashboard-quick-link" href="modules/accounts/vouchers/forms/transactions.html">
          <i data-lucide="arrow-left-right"></i><span>Transactions</span><small>Accounts</small>
        </a>
        <a class="dashboard-quick-link" href="modules/accounts/vouchers/forms/voucher-sales.html">
          <i data-lucide="receipt"></i><span>Sales Voucher</span><small>Accounts</small>
        </a>
      </div>
    </section>
